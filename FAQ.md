...
- Агент на основе So that... определяет фокус карты - Агент в праве сократить количество L2 до 3 (тут нужно математику продумать, тк сокращение количества L2 должно компенсироваться за счет увеличение % состава L4, иначе каждый результат будет огрыком, потмоу что так ИИ агенту просто удобнее будет)
- Агент на основе So that... определяет формирует состав L4
